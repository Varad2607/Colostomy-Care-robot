...
'''
Following code is from feature/aruco_navigation in Stretch_ros
https://github.com/hello-robot/stretch_ros/blob/feature/aruco_navigation/hello_helpers/src/hello_helpers/aruco_navigation.py

For detailed explaination:
https://forum.hello-robot.com/t/navigation-with-aruco-tags/483

This script will:
    - save the pose (position and orientation) from the aruco marker at the time of scanning
    - find_tag, return true if the requeted aruco marker is found
    - save_pose(pose name , aruco marker)
    - go to pose
'''
